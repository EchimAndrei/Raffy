...
""") as chat_interface:
    ...
    # # Obține calea absolută a fișierului 'raiffeisen.jpg'
    # image_path = os.path.join(current_dir, 'raiffeisen.jpg'))
    # <img src="{image_path}" alt="Raiffeisen Bank Logo" style="width:50px;height:auto;">
